...
#run in console: twarc configure
#twarc = Twarc()
#Twarc(CONSUMER_KEY, CONSUMER_SECRET, ACCESS_TOKEN, ACCESS_TOKEN_SECRET)
twarc = Twarc('EkbcpW0rvTUotOL5KwcKVsmdx','5htcN5FNqY83zKhbt1prkrzUciAHhXs0fSil9WiASToETvLcMf','1319503651098931201-n0iEpCLX1kbxuXr6YxVPnk7B8yno1V','6lDb95eOdgGcEVOsCiDV0wyGa5jssMzqMNe1b8WJyGFji')

data_dirs = ['2020-08', '2020-10']
os.chdir('E:\\')
